            ...
            <div className="main-menu-wrapper">
              ...
              <ul className="main-nav">
                ...
                <li className="has-submenu active">
                  ...
                  >
                    <li className={activeMenu === "PageNotification" ? "active" : ""}>
                      <Link to="/page-notification" onClick={hideMobileMenu}>
                        Notification
                      </Link>
                    </li>
                    <li className={activeMenu === "PricingPlan" ? "active" : ""}>
                ...
                <li className="has-submenu">
                  ...
                  >
                    <li className={activeMenu === "BlogList" ? "active" : ""}>
                      <Link to="/blog-list" onClick={hideMobileMenu}>
                        Blog List
                      </Link>
                    </li>
                    <li className={activeMenu === "BlogGrid" ? "active" : ""}>
                      <Link to="/blog-grid" onClick={hideMobileMenu}>
                        Blog Grid
                      </Link>
                    </li>
                    <li className={activeMenu === "BlogMasonry" ? "active" : ""}>
                      <Link to="/blog-masonry" onClick={hideMobileMenu}>
                        Blog Masonry
                      </Link>
                    </li>
                    <li className={activeMenu === "BlogModern" ? "active" : ""}>
                      <Link to="/blog-modern" onClick={hideMobileMenu}>
                        Blog Modern
                      </Link>
                    </li>
                    <li className={activeMenu === "BlogDetails" ? "active" : ""}>
